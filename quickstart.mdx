...
`fp-runtime` image and the [`fp-site-template`](https://github.com/frankenpress/site-template)
...
<Steps>
  ...
  <Step title="Install the chart">
    ...
    <Tip>
      ...
      site, fork [`fp-site-template`](https://github.com/frankenpress/site-template),
