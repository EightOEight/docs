...
<Steps>
  ...
  <Step title="Install the chart">
    ...
    <Note>
      ...
      `WP_HOME` defaults to `http://fp-site.localhost` and WordPress
    ...
    <Tip>
      ...
      `ghcr.io/eightoeight/fp-site-template` at the chart's `appVersion` tag. To deploy your own
  ...
  <Step title="Log in to your site">
    ...
    <Tip>
      ...
      line. See [`fp-charts` → First install](/components/fp-charts#first-install)
