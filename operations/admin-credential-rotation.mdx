...
- [Plan: install-job-credential-sync-gaps.md](https://github.com/frankenpress/frankenpress/blob/main/.aidocs/install-job-credential-sync-gaps.md) — the design rationale behind moving sync from the install Job to a Pod-lifecycle initContainer
