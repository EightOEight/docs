...
[`fp-runtime`](https://github.com/frankenpress/runtime) is the base
...
Full investigation log: [`fp-runtime/PHASE-0.md`](https://github.com/frankenpress/runtime/blob/main/PHASE-0.md).
