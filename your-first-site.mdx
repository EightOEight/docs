    ...
    <Tabs>
      <Tab title="Use this template (recommended)">
        ...
        - **Cons.** No "Sync fork" button. To pull upstream improvements
          ...
          ```bash
          git remote add upstream https://github.com/EightOEight/fp-site-template
          git fetch upstream
      ...
      <Tab title="Fork">
        Click **[Fork](https://github.com/EightOEight/fp-site-template/fork)**
        on `fp-site-template`. Pick an owner and the name `mysite`.
        ...
        - **Cons.** GitHub shows a "forked from" badge. Can't be made
          private if `fp-site-template` stays public, without using
